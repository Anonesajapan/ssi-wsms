...
public class IndustryTypeController {
    ...
    public String create(@Valid IndustryType industrytype, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/IndustryType/" + encodeUrlPathSegment(industrytype.getId().toString(), httpServletRequest);
    }
    ...
    public String show(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("industrytypes", industrytypeService.findIndustrytype(id));
        uiModel.addAttribute("itemId", id);
        return "IndustryType/show";
    }
