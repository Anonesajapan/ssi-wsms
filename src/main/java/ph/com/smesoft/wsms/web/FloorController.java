...
public class FloorController {
	...
	void populateEditForm(Model uiModel, Floor floor) {
    ...
    public ResponseEntity<String> showJson(@PathVariable("id") Long id) {
        ...
        try {
            ...
            return new ResponseEntity<String>(floor.toJson(), headers, HttpStatus.OK);
        } catch (Exception e) {
...
/*
	...
	public String listofFloor(@ModelAttribute("SearchCriteria") SearchForm searchForm, Model uiModel) {
		uiModel.addAttribute("floors", floorService.findFloorbyFloorNumber(searchForm.getSearchString()));
		return "floors/list";
	}
